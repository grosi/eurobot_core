...
#define MESSAGE_AIR "Error Air"
#define MESSAGE_AIR_COLUMN 0
#define MESSAGE_AIR_ROW 0
#define MESSAGE_FIRE_POOL_RIGHT "Error Pool R"
#define MESSAGE_FIRE_POOL_RIGHT_COLUMN 0
#define MESSAGE_FIRE_POOL_RIGHT_ROW 0
#define MESSAGE_FIRE_POOL_LEFT "Error Pool L"
#define MESSAGE_FIRE_POOL_LEFT_COLUMN 0
#define MESSAGE_FIRE_POOL_LEFT_ROW 0
