...
#define FIRE_POOL_HEARTPOOL_ANGLE_POSITION_RED      200
#define FIRE_POOL_HEART_FRONT_X_POSITION_RED 		500
#define FIRE_POOL_HEART_FRONT_Y_POSITION_RED		310
#define FIRE_POOL_HEART_X_POSITION_RED              320
#define FIRE_POOL_HEART_Y_POSITION_RED              240
