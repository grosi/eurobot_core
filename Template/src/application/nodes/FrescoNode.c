...
/* Private define ------------------------------------------------------------*/
/* Servo */
#define SERVO_FRESCO_STEP       10   /* Size of single step for the fresco servo */
#define SERVO_FRESCO_STEP_DELAY 20   /* Delay in ms to wait between steps */
