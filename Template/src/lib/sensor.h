...
#define SENSOR_1_PIN_MODE        GPIO_Mode_IN
#define SENSOR_1_PIN_SPEED       GPIO_Speed_2MHz
#define SENSOR_1_PIN_TYPE        GPIO_OType_PP
#define SENSOR_1_PIN_PUPD        GPIO_PuPd_UP
#define SENSOR_1_PORT_CLK        RCC_AHB1Periph_GPIOC
#define SENSOR_1_PORT            GPIOC
#define SENSOR_1_EXTI_PORT       EXTI_PortSourceGPIOC
#define SENSOR_1_EXTI_PIN        EXTI_PinSource5
#define SENSOR_1_EXTI_LINE       EXTI_Line5
#define SENSOR_1_EXTI_TRIG       EXTI_Trigger_Falling
#define SENSOR_1_EXTI_CHAN       EXTI9_5_IRQn
#define SENSOR_1_EXTI_PPRIO      5
#define SENSOR_1_EXTI_SPRIO      0

#define SENSOR_FIRE_POOL_PIN             GPIO_Pin_4
#define SENSOR_FIRE_POOL_PIN_MODE        GPIO_Mode_IN
#define SENSOR_FIRE_POOL_PIN_SPEED       GPIO_Speed_2MHz
#define SENSOR_FIRE_POOL_PIN_TYPE        GPIO_OType_PP
#define SENSOR_FIRE_POOL_PIN_PUPD        GPIO_PuPd_UP
#define SENSOR_FIRE_POOL_PORT_CLK        RCC_AHB1Periph_GPIOC
#define SENSOR_FIRE_POOL_PORT            GPIOC
#define SENSOR_FIRE_POOL_EXTI_PORT       EXTI_PortSourceGPIOC
#define SENSOR_FIRE_POOL_EXTI_PIN        EXTI_PinSource4
#define SENSOR_FIRE_POOL_EXTI_LINE       EXTI_Line4
#define SENSOR_FIRE_POOL_EXTI_TRIG       EXTI_Trigger_Falling
#define SENSOR_FIRE_POOL_EXTI_CHAN       EXTI4_IRQn
#define SENSOR_FIRE_POOL_EXTI_PPRIO      5
#define SENSOR_FIRE_POOL_EXTI_SPRIO      0
...
extern void initSensor_Fire_Pool();
extern uint8_t getSensor_Fire_Pool();
extern uint8_t getSensorPosEdge_Fire_Pool(uint8_t*);
extern uint8_t getSensorNegEdge_Fire_Pool(uint8_t*);
...
extern void initSensor_1();
extern uint8_t getSensor_1();
extern uint8_t getSensorPosEdge_1(uint8_t*);
extern uint8_t getSensorNegEdge_1(uint8_t*);
