...
/**
 * \fn      initSensorEXTI_Fire_Pool
 * \brief   initialisation of the EXTI-line
 */
void initSensorEXTI_Fire_Pool()
{
    initEXTILine(SENSOR_FIRE_POOL_PORT_CLK, SENSOR_FIRE_POOL_EXTI_PORT, SENSOR_FIRE_POOL_EXTI_PIN,
                SENSOR_FIRE_POOL_EXTI_LINE, SENSOR_FIRE_POOL_EXTI_TRIG, SENSOR_FIRE_POOL_EXTI_CHAN,
                SENSOR_FIRE_POOL_EXTI_PPRIO, SENSOR_FIRE_POOL_EXTI_SPRIO);
}
...
{
    initEXTILine(SENSOR_1_PORT_CLK, SENSOR_1_EXTI_PORT, SENSOR_1_EXTI_PIN,
                SENSOR_1_EXTI_LINE, SENSOR_1_EXTI_TRIG, SENSOR_1_EXTI_CHAN,
                SENSOR_1_EXTI_PPRIO, SENSOR_1_EXTI_SPRIO);
}
